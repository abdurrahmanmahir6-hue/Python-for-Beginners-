...
To print any text, we have to give a double quote or a single quote. If we do not give quite, python will not understand that Hello, World! is a text, it has to be printed.

We do not have to use quote to print a number. We can write the number directly.
```python
print(10)
print(5.6)
print(10+10)
...
20
```
> note: if we write something between quote, python sees it as text.
